      ...
      <div className="container-narrow text-center">
        ...
        >
          ...
          <a
            ...
            className="bg-black hover:inspo-gradient-bg shimmer-btn text-white font-semibold text-lg px-10 py-4 rounded-pill inline-flex items-center gap-2 transition-all duration-300 shadow-inspo-lg hover:shadow-[0_8px_30px_rgba(0,140,255,0.2)] hover:-translate-y-[1px]"
          >
            <Sparkles size={20} />
            Try It Free
          </a>
