...
const MockupImage = ({ src, alt, className }: { src: string; alt: string; className?: string }) => (
    <img
        ...
        onError={(e) => {
            e.currentTarget.src = "https://images.unsplash.com/photo-1557683316-973673baf926?auto=format&fit=crop&q=80&w=800";
        }}
    />
);
    ...
    <div className="w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
            <div className="aspect-[4/5] rounded-3xl bg-slate-900 overflow-hidden shadow-2xl relative">
                ...
                <div className="absolute bottom-8 left-10 right-10 h-12 bg-pink-500 rounded-full flex items-center justify-center font-bold text-white uppercase text-xs tracking-widest">Shop Now</div>
...
export const ColorExtractionMockup = () => (
    <div className="bg-white rounded-[24px] border border-border shadow-inspo p-8 max-w-[500px] w-full">
        ...
        <button className="w-full mt-10 p-4 rounded-2xl inspo-gradient-bg text-white font-black text-xs uppercase tracking-[0.2em] shadow-lg shadow-blue-500/20 active:scale-95 transition-transform">Save to Moodboard</button>
    </div>
);
        ...
        <div className="flex-1 flex flex-col bg-white">
            <div className="h-14 border-b border-border flex items-center justify-between px-6">
                ...
                <div className="flex gap-2">
                    ...
                    <div className="px-4 h-8 rounded-lg bg-black text-white text-[10px] font-black flex items-center">EXPORT</div>
                </div>
            </div>
