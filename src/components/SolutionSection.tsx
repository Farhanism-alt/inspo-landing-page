...
const BrowserFrame = () => (
  <div className="bg-card rounded-[24px] border border-border shadow-[0_20px_60px_rgba(0,0,0,0.08)] w-full max-w-[520px] mx-auto overflow-hidden">
    ...
    <div className="flex">
      <div className="w-12 bg-foreground/95 flex flex-col items-center py-4 gap-4 shrink-0">
        {sidebarIcons.map((Icon, i) => (
          <div key={i} className={`w-7 h-7 rounded-lg flex items-center justify-center ${i === 0 ? "bg-primary-foreground/20" : ""}`}>
...
const CreatorSatellite = () => (
  <div className="bg-card rounded-xl border border-border shadow-inspo p-3 w-[150px]">
    <div className="flex items-start gap-1.5 mb-2">
      ...
      <div className="bg-foreground text-primary-foreground text-[9px] px-2 py-1 rounded-lg rounded-tl-none">Design a hero section</div>
    </div>
    ...
    <section className="section-padding" style={{ background: "#f9f9f9" }}>
      <div className="container-narrow">
        <div className="text-center mb-20">
          <BlurReveal as="h2" className="font-display text-3xl sm:text-4xl font-extrabold tracking-[-0.03em] text-foreground mb-5">
        ...
        >
          <div className="relative lg:min-h-[520px] flex flex-col items-center">
            <ConnectionLines />
            <div className="relative z-10 lg:mt-8">
              <BrowserFrame />
            </div>
            <div className="flex gap-3 overflow-x-auto pb-2 mt-6 lg:mt-0 lg:overflow-visible lg:static lg:gap-0 w-full">
              {satellites.map(({ Component, className }, i) => (
                <motion.div
                  key={i}
        ...
        >
          <a
            ...
            className="bg-black hover:inspo-gradient-bg shimmer-btn text-white font-semibold text-base px-8 py-3.5 rounded-pill inline-flex items-center gap-2 shadow-inspo-lg transition-all duration-300 hover:-translate-y-[1px] hover:shadow-[0_8px_30px_rgba(0,140,255,0.2)]"
          >
            <Sparkles size={18} />
            Try It Free
          </a>
