...
const Agencies = () => {
    return (
        <UseCaseLayout>
            <SEO
                title="Competitive Brand Analysis Tool for Agencies | Inspo AI"
                description="Build pitch moodboards in minutes. Scan competitor brands before client meetings. Speed up ideation with AI design search. Free to start."
                keywords="agency competitive brand analysis tool"
            />
            ...
            <section className="py-32 px-4 text-center">
                ...
                <a href="https://app.inspoai.io" className="bg-black hover:inspo-gradient-bg shimmer-btn text-white font-semibold text-lg px-12 py-5 rounded-pill shadow-xl inline-block">
                    Try It Free
                </a>
            </section>
        </UseCaseLayout>
