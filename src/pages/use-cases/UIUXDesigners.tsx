    ...
    return (
        <UseCaseLayout>
            <SEO
                ...
                description="Find UI design inspiration by style, color, and industry. Build client moodboards in minutes. Audit designs for brand compliance. Free to start."
                keywords="design inspiration tool for UI designers"
            />
