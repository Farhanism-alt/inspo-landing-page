    ...
    return (
        <UseCaseLayout>
            <SEO
                ...
                description="Audit every design for brand compliance in seconds. Scan competitor websites for brand DNA. Keep your visual identity consistent with Inspo AI."
                keywords="brand compliance audit tool"
            />
