    ...
    return (
        <UseCaseLayout>
            <SEO
                ...
                description="Create visual briefs for campaigns. Align creative direction before design starts. Audit marketing assets for brand compliance. Free to start."
                keywords="campaign moodboard tool"
            />
