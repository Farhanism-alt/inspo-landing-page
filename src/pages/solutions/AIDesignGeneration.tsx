...
const AIDesignGeneration = () => {
    return (
        <UseCaseLayout>
            <SEO
                title="AI Design Generator | Text to Web Design | Inspo AI"
                description="Describe a web design in plain English and AI generates live HTML and CSS. Preview on desktop, tablet, and mobile. Copy the code. Iterate through chat."
                keywords="AI design generator"
            />
