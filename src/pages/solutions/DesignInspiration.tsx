    ...
    return (
        <UseCaseLayout>
            <SEO
                ...
                description="Search for design inspiration using natural language and AI filters. Find references by industry, style, color, and font in seconds. Free to start."
                keywords="AI design inspiration tool"
            />
