...
const BrandIntelligence = () => {
    return (
        <UseCaseLayout>
            <SEO
                title="Brand Intelligence Platform | Audit and Monitor Brands | Inspo AI"
                description="Audit designs for brand compliance with AI scoring. Scan competitor websites to extract brand DNA. Build brand intelligence workflows with Inspo AI."
                keywords="brand intelligence platform"
            />
