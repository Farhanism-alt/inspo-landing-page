    ...
    return (
        <UseCaseLayout>
            <SEO
                ...
                description="Scan any competitor website and extract colors, fonts, tech stack, pricing, and SEO data in 60 seconds. Visualized as an interactive node graph."
                keywords="competitor website analysis tool"
            />
