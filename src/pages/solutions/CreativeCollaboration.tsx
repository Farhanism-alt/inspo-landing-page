...
const CreativeCollaboration = () => {
    return (
        <UseCaseLayout>
            <SEO
                title="Creative Collaboration Tool | Real-Time Moodboards for Teams | Inspo AI"
                description="Build moodboards together in real time. Share creative direction with clients via public links. Align design teams with visual references. Free to start."
                keywords="creative collaboration tool for design teams"
            />
