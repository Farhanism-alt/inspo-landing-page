            ...
            <main className="flex-1 py-16 md:py-24 max-w-4xl mx-auto w-full px-4 sm:px-6 legal-content">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground mt-12">
                    ...
                    <div className="space-y-8 mb-12">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-foreground">Niranjan K — UI/UX Design</h3>
                            <p className="mt-2">
                                Niranjan is a Visual and UI Designer with over 3 years at Paperflite, specialising in turning complex ideas into high-impact experiences. He shaped the interface and user experience of InspoAI, making it feel intuitive for the creatives it was built for.
                            </p>
                        </div>

                        <div>
                            <h3 className="text-lg font-bold text-foreground">Thiru Sharma — Design & Development</h3>
                            <p className="mt-2">
                                Thiru is the rare kind of person who can design it and build it. A UI/UX designer and developer skilled in Flutter, React Native, and React JS, he bridged the gap between design and code — bringing the product to life with both craft and technical precision.
                            </p>
                        </div>

                        <div>
                            <h3 className="text-lg font-bold text-foreground">Mohamed Siraj — DevOps & Technical Mentor</h3>
                            <p className="mt-2">
                                Siraj brought the engineering backbone. A Full-Stack Developer and DevOps Engineer experienced in MERN Stack, Docker, AWS, and CI/CD pipelines, he ensured InspoAI was not just functional but scalable, reliable, and production-ready. He also served as a technical mentor for the team throughout the build.
                            </p>
                        </div>

                        <div>
                            <h3 className="text-lg font-bold text-foreground">Sarhan Ram — Content & Promotional Direction</h3>
                            <p className="mt-2">
                                Sarhan led the storytelling side — directing the promotional video and shaping the narrative that communicated InspoAI's value to the audience. Great products need great stories, and Sarhan made sure InspoAI had one.
                            </p>
                        </div>
                    </div>
